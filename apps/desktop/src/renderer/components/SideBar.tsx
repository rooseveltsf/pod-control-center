...
function SideBar() {
    return (
        <>
            <aside className="fixed left-0 top-0 hidden h-screen w-64 flex-col border-r border-white/7 bg-white/[0.02] px-5 py-6 lg:flex">
                ...
                <nav className="space-y-1 text-sm">
                    <NavLink
                        style={({ isActive }) => ({
                            backgroundColor: isActive ? "rgba(109, 94, 252, 0.16)" : "transparent",
                        })}
